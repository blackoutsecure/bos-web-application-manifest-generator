...
describe('Web Application Manifest Generator', () => {
  describe('processManifest', () => {
    ...
    it('should set default values for optional members', () => {
      ...
      assert.strictEqual(manifest.icons[1].src, '/android-chrome-256x256.png');
    });
    ...
    it('should validate orientation values', () => {
      ...
      assert.strictEqual(invalidManifest.orientation, 'any');
    });
  ...
  describe('validateManifest', () => {
    ...
    it('should warn when using combined any maskable purpose', () => {
      const manifest = {
        name: 'Test App',
  ...
  // Favicon mode removed; defaults are applied directly without mode flags
});
